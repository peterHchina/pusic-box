...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    if (drawTitle)
    {
        ...
        if ([self.window isKeyWindow])
            textColor = [NSColor colorWithCalibratedRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0];
        else
            textColor = [NSColor colorWithCalibratedRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0];
...
#pragma mark - QMBorderlessWindow
